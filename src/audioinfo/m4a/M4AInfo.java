...
import audioinfo.mp3.ID3v1Genre;
 ...
 *
 * [ftyp] - brand name (should be 'MP4A') and version [moov] [mvhd] - duration,
 * speed, volume [trak] [mdia] [mdhd] - sample rate, duration [udta] [meta]
 * [ilst] [©nam] title [©ART] artist [aART] album artist [©alb] album [©day]
 * year [©cmt] comment [gnre, ©gen] genre (standard or custom, not both) [trkn]
 * track number [disk] disk number [©wrt, ©com] composer (iTunes seems to use
 * only ©wrt) [tmpo] BPM [cprt, ©cpy] copyright (occurrence of ©cpy is
 * unconfirmed) [cpil] compilation [covr] cover [rtng] rating [©grp] grouping
 * (also [grup]?) [©lyr] lyrics
 *
 * Further iTunes atoms which are not examined: [----] ??? [pgap] gapless
 * playback [apID] apple store account [©enc] encoded by [©too] tool [desc,
 * ©des] description (also [dscp]?) [ldes] long description [stik] media type
 * (0-Movie, 1-Music, 2-Audiobook, 5-Whacked Bookmark, 6-Music Video, 9-Short
 * Film, 10-TV Show, 11-Booklet, 14-Ringtone, 21-Podcast) [catg] category [keyw]
 * keyword [pcst] podcast flag [purl] podcast url [egid] episode global unique
 * id [tvnn] TV network name [tvsh] TV show name [tven] TV episode number [tvsn]
 * TV season [tves] TV episode [hdvd] HD video flag [itnu] iTunesU flag [purd]
 * purchase date [auth] author [perf] performer [titl] title [yrrc] year (of
 * recording?) [akID] iTunes store account type (0-iTunes, 1-AOL) [atID] album
 * title id [cnID] apple store catalog id [geID] genre id [plID] playlist id
 * [sfID] iTunes store country code (143441-USA, 143442-France, 143443-Germany,
 * 143444-UK, 143445-Austria, 143446-Belgium, 143447-Finland, 143448-Greece,
 * 143449-Ireland, 143450-Italy, 143451-Luxembourg, 143452-Netherlands,
 * 143453-Portugal, 143454-Spain, 143455-Canada, 143456-Sweden, 143457-Norway,
 * 143458-Denmark, 143459-Switzerland, 143460-Australia, 143461-New Zealand,
 * 143462-Japan) [soaa] sort album artist [soal] sort album [soar] sort artist
 * [soco] sort composer [sonm] sort name [sosn] sort show
 *
 */
