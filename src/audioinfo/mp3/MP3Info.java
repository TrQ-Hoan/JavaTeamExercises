...
/**
 * MP3 audio info. Puts together ID3v1, ID3v2 and MP3 duration calculation.
 */
public class MP3Info extends AudioInfo {
    ...
    /**
     * Searches for an audio frame with a compatible follow-up header. The stop
     * condition is be used to make sure that the search ends as soon as the
     * stop condition says so. This method reads the follow-up frame header and
     * checks it for compatibility with the header of the candidate frame. If
     * compatible, the next header is attached to the frame and the frame is
     * returned. Otherwise, the frame is discarded.
     *
     * @param data
     * @param stopCondition
    ...
    /**
     * Reads the audio frame immediately following the given previous frame. The
     * stop condition is be used to make sure that the search ends as soon as
     * the stop condition says so. This method reads the follow-up frame header
     * and checks it for compatibility with the header of the previous frame. If
     * compatible, the next header is attached to the returned frame.
     *
     * @param data
     * @param stopCondition
     * @param previousFrame
